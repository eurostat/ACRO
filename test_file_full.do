...
*  safe_setup "`working_folder'" default test_results suppress
  safe_setup "`working_folder'" cis test_results suppress
  ...
  ************************************************************************************
  ...
  safe regress inc_activity inc_grants inc_donations total_costs
	 ...
	 safe xtreg inc_activity inc_grants inc_donations total_costs , re 		
		* coefficient tests and then 2 general t-tests on means (the second of these is designed to fail the DoF rule
		safe test inc_grants inc_donations 
		safe ttest inc_grant==inc_donations
		safe ttest inc_grant==inc_donations if _n<8		
